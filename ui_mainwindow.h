...
"QPushButton:pressed { background-color: #455A64; transform: translateY(1px); }"));
        ...
        stopAutomationLabel = new QLabel(automationGroup);
        stopAutomationLabel->setObjectName("stopAutomationLabel");
        stopAutomationLabel->setStyleSheet(QString::fromUtf8("font-size: 10pt; color: #e67e22; font-weight: bold;"));
